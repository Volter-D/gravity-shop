...
<body class="bg-dark">>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
        ...
        <div class="container-fluid">
          ...
          <a class="nav-link dropdown-toggle" href="chaquetas.php" role="button" data-bs-toggle="dropdown" aria-expanded="false" id="ropa" >
          <strong> Delineadores</strong>
          </a>
  ...
  <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0m7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0m-1.646-7.646-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L8 8.293l2.646-2.647a.5.5 0 0 1 .708.708"/>
    ...
    <h1 class="textod"> <style>.textod{color: white;} </style><strong>DELINEADORES</strong></h1>
        <br>
        <div class="row">
            <!-- Producto 1 -->
            <div  class="col-md-3">
                <div class="card">
                    <img  class="imgr1" src="imgmaquillaje/delineador1.jpeg" class="card-img-top" alt="Producto 1">
                    <div class="card-body text-center">
                        <h5 class="card-title">Delineador Plumón Tattoo</h5>
                        <p class="card-text">Precio: $11.10</p>
                        <button class="btn btn-dark add-to-cart" data-id="1" data-name="Delineador Plumón "  data-price="11.10">Agregar al Carrito</button>
                    </div>
                </div>
            </div>
            <!-- Producto 2 -->
            <div class="col-md-3">
                <div class="card">
                    <img class="imgr2" src="imgmaquillaje/delineador2.jpeg" class="card-img-top" alt="Producto 2">
                    <div class="card-body text-center">
                        <h5 class="card-title">Paletas de Sombras 12 tonos</h5>
                        <p class="card-text">Precio: $22.70</p>
                        <button class="btn btn-dark add-to-cart" data-id="2" data-name="Paletas de Sombras " data-price="22.70">Agregar al Carrito</button>
                    </div>
                </div>
            </div>
            <!-- Producto 3 -->
            <div class="col-md-3">
                <div class="card">
                    <img class="imgr3" src="imgmaquillaje/delineador3.jpeg" class="card-img-top" alt="Producto 3">
                    <div class="card-body text-center">
                        <h5 class="card-title">Delineador Líquido 
                        Punta Inteligente </h5>
                        <p class="card-text">Precio: $14.50</p>
                        <button class="btn btn-dark add-to-cart" data-id="3" data-name="Punta Inteligente" data-price="14.50">Agregar al Carrito</button>
                    </div>
                </div>
            </div>
            <!-- Producto 4 -->
            <div class="col-md-3">
                <div class="card">
                    <img class="imgr4" src="imgmaquillaje/delineador4.jpeg" class="card-img-top" alt="Producto 4">
                    <div class="card-body text-center">
                        <h5 class="card-title">Delineador Larga 
                        Duración para Ojos</h5>
                        <p class="card-text">Precio: $ 7.20</p>
                        <button class="btn btn-dark add-to-cart" data-id="4" data-name="Delineador Larga Duración" data-price=" 7.20">Agregar al Carrito</button>
                    </div>
                </div>
            </div>
        </div>
